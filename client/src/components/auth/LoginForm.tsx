      ...
      <div className="hidden w-1/2 flex-col justify-center bg-slate-50 px-16 lg:flex dark:bg-slate-900">
        <div className="max-w-md">
          ...
          <p className="mt-6 text-[15px] leading-relaxed text-slate-500 dark:text-slate-400">
            Pipeline Tracker combines intelligent JD parsing, visual pipeline management, and AI-powered resume suggestions into a single, cohesive workflow for modern job seekers.
          </p>

          <div className="mt-12 flex gap-12">
            <div>
              <p className="text-2xl font-extrabold text-slate-900 dark:text-white">5-stage</p>
              <p className="text-sm text-slate-400 dark:text-slate-500">Visual pipeline</p>
            </div>
            <div>
              <p className="text-2xl font-extrabold text-slate-900 dark:text-white">AI</p>
              <p className="text-sm text-slate-400 dark:text-slate-500">Smart parsing</p>
            </div>
          </div>
        </div>
      </div>
